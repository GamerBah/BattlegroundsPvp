...
public class Bowman extends Kit {
    ...
    protected void wear(Player player) {
        ...
        ItemStack bow = new ItemStack(new I(Material.BOW).name(Rarity.COMMON.getColor() + "Trusty Bow").enchantment(Enchantment.ARROW_DAMAGE, 1).enchantment(Enchantment.ARROW_INFINITE).enchantment(Enchantment.ARROW_KNOCKBACK, 1).unbreakable().flag(ItemFlag.HIDE_ATTRIBUTES).flag(ItemFlag.HIDE_UNBREAKABLE));
