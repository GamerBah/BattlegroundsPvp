...
public class HelpCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            player.sendMessage(BoldColor.DARK_AQUA.getColor() + " /friend " + ChatColor.GRAY + "- Add, remove, and view friends!");
        ...
        if (args.length == 1 && args[0].equalsIgnoreCase("staff")) {
            ...
            player.sendMessage(BoldColor.DARK_AQUA.getColor() + " /warn " + ChatColor.GRAY + "- warns a player");
